      ...
      <div class="col-md-12">
            ...
            <div class="row">
              ...
              <div class="col-lg-3 offset-lg-5">
                <div class="social-icon">
                  ...
                  <a target="_blank" href="#" class=" fa fa-youtube" />{" "}
                  <a target="_blank" href="#" class=" fa fa-vimeo-square" />{" "}
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="top-head left">
          <div class="container">
            <div class="row">
              <h1 align="center">
                <a href="/search">San Jose Times</a>
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="card">
                  ...
                  <img
                    class="img-fluid"
                    src="http://grafreez.com/wp-content/temp_demos/river/img/politics.jpg"
                    alt=""
                  />
                ...
                <div class="card">
                  ...
                  <img
                    class="img-fluid"
                    src="http://grafreez.com/wp-content/temp_demos/river/img/travel.jpg"
                    alt=""
                  />
                  <div class="card-img-overlay">
                    {" "}
                      ...
                      <div class="news-block">
                        ...
                        <div class="news-title">
                          <h2 class=" title-large">
                            <a href="#">
                              Ray madison may struggle to get best from Paul in
                              a 4-2-3-1 formation
                            </a>
                          </h2>
                        </div>
                        <div class="news-des">
                          Condimentum ultrices mi est a arcu at cum a elementum
                          per cum turpis dui vulputate vestibulum in vehicula
                          montes vel. Mauris nam suspendisse consectetur mus...
                        </div>
                        <div class="time-text">
                    ...
                    <div class="carousel-item">
                      <div class="news-block">
                        ...
                        <div class="news-title">
                          <h2 class=" title-large">
                            <a href="#">
                              An Alternative Form of Mental Health Care Gains a
                              Foothold
                            </a>
                          </h2>
                        </div>
                    ...
                    <div class="carousel-item">
                      <div class="news-block">
                        ...
                        <div class="news-title">
                          <h2 class=" title-large">
                            <a href="#">
                              Key Republican Senator Says She Will Not Vote for
                              former president!
                            </a>
                          </h2>
                        </div>
                ...
                <div class="">
                  <div class="col-lg-6 card">
                    <div class="card">
                      ...
                      <img
                        class="img-fluid"
                        src="http://grafreez.com/wp-content/temp_demos/river/img/war.jpg"
                        alt=""
                      />
                      <div class="card-body">
                        <div class="news-title">
                  ...
                  <div class="col-lg-6 card">
                    <div class="card">
                      ...
                      <img
                        class="img-fluid"
                        src="http://grafreez.com/wp-content/temp_demos/river/img/travel1.jpg"
                        alt=""
                      />
                      <div class="card-body">
                        <div class="news-title">
